...
namespace MVCProjectCamp.Controllers
{
    public class AdminCategoryController : Controller
    {
        ...
        [Authorize(Roles="Y")] //Bu komutla categorysayfasını yalnızca hesaba giriş yapmış kişiler görebilecek. burada eklediğimiz Roles="Y" ile de bu kısmı sadece B rolüne sahip admin görsün dedik.
