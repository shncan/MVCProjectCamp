namespace DataAccessLayer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataAccessLayer.Concrete.Context>
    {
        ...
        {
            AutomaticMigrationsEnabled = true; // Bu kısım enable-migrations dediğimiz için false geliyor, migrations'ta değişiklikler yapabilmek için burayı true yapıyoruz.
        }
